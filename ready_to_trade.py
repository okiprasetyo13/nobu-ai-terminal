...
if armed:
    ...
    st.metric(label="Live Price", value=f"{current_price:.4f}" if current_price else "Loading...")

    pnl = ((current_price - armed["entry"]) / armed["entry"]) * 100 if current_price else 0
